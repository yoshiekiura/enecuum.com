    ...
    mounted() {
      ...
      socket.on('depositUpdates', (info) => {
        ...
        this.$notify({
          ...
          message: '<p>' + (me ? 'You bought ' : '') + info.amount + ' tokens was sold for ' + info.ether + ' ether (' + (me ? '' : 'you can') + 'see <a target="_blank" href="https://etherscan.io/tx/' + info.tx + '">tx details</a>)</p>',
